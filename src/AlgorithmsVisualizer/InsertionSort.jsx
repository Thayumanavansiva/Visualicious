    ...
    return (
        ...
        <Box sx={{ flexGrow: 1}}>
            <AppBar position="fixed" sx={{backgroundColor:"black", height: "70px"}}>
                ...
                <FormControlLabel control={<Checkbox defaultChecked   sx={{color: "#229799",'&.Mui-checked': {color: "#229799"}}}/>} label="Soker Mode 🤡!"></FormControlLabel>
                </Box>
        ...
        <Stack direction="row" spacing={0.5} sx={{height: "90vh", mx: {"xs": "0px", "md": "130px"}, paddingTop: "60px", justifyContent: "center"}}>
                ...
                array.map((value, index) => (
                    ...
                    <img src="/public/gokul.jpg" width={`${Math.floor(window.innerWidth / (arraySize* 3))}px`}></img>
