...
export default function NavBar({name, arraySize, updateArraySize, speed, updateSpeed, isSokerMode, updateSokerMode, disabled, Sokers, caller}) {
    return (
        <>
        <Box sx={{ flexGrow: 1}}>
            <AppBar position="fixed" sx={{backgroundColor:"black", height: "70px"}}>
                ...
                <div style={{ padding: "20px 0px 0px 20px" }}>
                            <Button sx={{ textAlign: "center" }} disabled={disabled}>
                                <Typography onClick={caller} variant="body2" component="div" sx={{ fontFamily: "Pixelify Sans" }}>
                                    Sort Now!
                                </Typography>
                            </Button>
                        </div>         
